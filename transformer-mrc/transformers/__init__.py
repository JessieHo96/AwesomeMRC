...
if is_torch_available():
    ...
    from .modeling_bert import (BertPreTrainedModel, BertModel, BertForPreTraining,BertForQuestionAnsweringLSTMBiDAFPooler,
                                ...
                                BertForQuestionAnsweringAVPoolBCE,BertForQuestionAnsweringAVPoolBCEv3,BertForQuestionAnsweringSeqSCAVPooler,BertForQuestionAnsweringLSTM,BertForQuestionAnsweringSeqSCLSTMAVPooler,
    ...
    from .modeling_albert import (AlbertPreTrainedModel, AlbertModel, AlbertForMaskedLM, AlbertForSequenceClassification,AlbertForQuestionAnsweringAVPoolerLSTM,
