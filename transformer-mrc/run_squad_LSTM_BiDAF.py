...
def main():
    ...
    if args.do_eval and args.local_rank in [-1, 0]:
        ...
        val_dataset, val_examples, val_features = load_and_cache_examples(args, tokenizer, evaluate=True, output_examples=True)
        for checkpoint in checkpoints:
            ...
            # Evaluate
            result = evaluate(args, model, tokenizer, val_dataset, val_examples, val_features,prefix=global_step)
